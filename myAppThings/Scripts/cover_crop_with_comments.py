...
# Keeps type hints simple; it does not change how the app runs.
...
# What it does: This is the cropped image result.
...
# What it does: This is the cover crop window.
# What it reads/writes: If it reads or writes files, it only uses local app files it creates (like settings/temp) or files you choose.
# What it never touches: The internet, passwords, or private files you did not choose.
class CropWindow(tk.Toplevel):

    # What it does: Sets up the cover crop window.
    # What it reads/writes: If it reads or writes files, it only uses local app files it creates (like settings/temp) or files you choose.
    # What it never touches: The internet, passwords, or private files you did not choose.
    ...
    # What it does: Handles a user action in the cover crop window.
    # What it reads/writes: If it reads or writes files, it only uses local app files it creates (like settings/temp) or files you choose.
    # What it never touches: The internet, passwords, or private files you did not choose.
    ...
    # What it does: Handles redraw rect in the app.
    # What it reads/writes: If it reads or writes files, it only uses local app files it creates (like settings/temp) or files you choose.
    # What it never touches: The internet, passwords, or private files you did not choose.
    ...
    # What it does: Handles do crop in the app.
    # What it reads/writes: If it reads or writes files, it only uses local app files it creates (like settings/temp) or files you choose.
    # What it never touches: The internet, passwords, or private files you did not choose.
    def _do_crop(self):
